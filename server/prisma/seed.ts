...
async function main() {
    ...
    // create commuTheme(테마 파크_commuId:1_4)
    await prisma.commuTheme.create({
        data: {
            commuId: 1,
            commuThemeName: "랜드마크",
    ...
    // create commuTheme(랜드마크_commuId:1_3)
    await prisma.commuTheme.create({
        data: {
            commuId: 1,
    ...
    // posting(user4_theme3(테마 파크)_11)
    await prisma.post.create({
        data: {
            userId: 4,
            commuThemeId: 3,
    ...
    // posting(user4_theme4(랜드 마크)_12)
    await prisma.post.create({
        data: {
            userId: 4,
            commuThemeId: 4,
